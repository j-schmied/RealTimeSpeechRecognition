"""
Derivative of test_livetranscript

Works only for English language 

Source: https://www.assemblyai.com/docs/Guides/identifying_speakers_in_audio_recordings
"""
import argparse
...
def main():
    ...
    temp_file_ext = NamedTemporaryFile(suffix=".raw", delete=False).name
    ...
    print("[*]\tLive transcription ready, start speaking...")
    ...
    while True:
        try:
            ...
            if not data_queue.empty():
                ...
                # TODO: Find optimal attention time
                ...
                # Transcribe
                transcript = transcriber.transcribe(temp_file, config=aai.TranscriptionConfig(speaker_labels=True))
                ...
                for utterance in utterances:
                    ...
                    text = utterance.text
                    print(f"[{datetime.now().strftime('%H:%M:%S')}, {speaker}] {text}")
